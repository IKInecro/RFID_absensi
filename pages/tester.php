...
<div class="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg" style="max-width:1000px;margin:20px auto;">
  <div class="flex flex-col sm:flex-row justify-between items-center mb-4 gap-3">
    <h1 class="text-2xl font-bold text-center sm:text-left">Presenter: Live Absensi (Tester)</h1>
    <button id="clearBtn" class="bg-red-600 hover:bg-red-700 text-white px-5 py-2 rounded-lg shadow-md transition text-sm sm:text-base">
      🧹 Clear Data
    </button>
  </div>
  <p class="mb-4 text-sm text-gray-400 text-center sm:text-left">Data diperbarui otomatis setiap 3 detik.</p>

  <div class="overflow-x-auto">
    <table class="min-w-full border border-gray-700" id="testerTable">
      <thead class="bg-gray-700 text-gray-100 text-left">
        <tr>
          <th class="p-3">#</th>
      ...
      <tbody id="testerBody">
        <tr><td colspan="7" class="p-4 text-center text-gray-400">Memuat data...</td></tr>
      </tbody>
    </table>
  </div>
</div>
